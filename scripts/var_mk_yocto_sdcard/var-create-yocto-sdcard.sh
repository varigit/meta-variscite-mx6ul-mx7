...
function flash_yocto
{
    ...
    echo "----------------------------------"
    sudo dd if=tmp/deploy/images/imx6ul-var-dart/u-boot-sd-2015.04-r0.imx of=${node} bs=1K seek=1; sync
...
echo "nand u-boot..."
sudo cp tmp/deploy/images/imx6ul-var-dart/u-boot-nand-2015.04-r0.imx			/tmp/rootfs/opt/images/Yocto/
echo "sd u-boot..."
sudo cp tmp/deploy/images/imx6ul-var-dart/u-boot-sd-2015.04-r0.imx			/tmp/rootfs/opt/images/Yocto/
}
