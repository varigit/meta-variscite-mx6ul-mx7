...
function flash_yocto
{
    ...
    sudo dd if=tmp/deploy/images/imx6ul-var-dart/u-boot.img-sd of=${node} bs=1K seek=69; sync
...
sudo cp tmp/deploy/images/imx6ul-var-dart/u-boot.img-nand			/tmp/rootfs/opt/images/Yocto/
echo "sd u-boot..."
sudo cp tmp/deploy/images/imx6ul-var-dart/SPL-sd					/tmp/rootfs/opt/images/Yocto/
sudo cp tmp/deploy/images/imx6ul-var-dart/u-boot.img-sd					/tmp/rootfs/opt/images/Yocto/
}
